...
def train(args):
    ...
    # depth-map cache setup (details in the conv_depth_add script)
...
if __name__ == '__main__':
    ...
    parser.set_defaults(
        ...
        use_depth=4,
        depth_feat_channels=3, # Hiera wants 3-channel input
    )

    from utils.run_config import apply_run_config_defaults
    apply_run_config_defaults(parser, dataset='IOCfish', exclude=('depth_feat_channels',))
