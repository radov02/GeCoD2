# FSCD-147 version of the separate_Hiera_on_RGB_and_depth IOCfish training script.
import argparse
import os
import random
...
if __name__ == '__main__':
    ...
    apply_run_config_defaults(parser, dataset='FSCD147', exclude=('depth_feat_channels',))
