# MCAC version of the conv_on_depth_feats_addition_with_Hiera_feats IOCfish training script.
import argparse
import os
import random
...
if __name__ == '__main__':
    ...
    parser.set_defaults(
        ...
        aux_weight=0.3,
        # Depth fusion
        use_depth=1, # fusion mode 1
        depth_kernel_size=1, # 1x1 fusion
    ...
    apply_run_config_defaults(parser, dataset='MCAC')
